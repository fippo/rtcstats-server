...
function wsConnectionHandler(client, upgradeReq) {
    ...
    demuxSink.on('close-sink', ({ id, meta }) => {
        ...
        const dumpData = {
            ...
            sessionId: meta.meetingUniqueId ? String(meta.meetingUniqueId) : null,
            ...
            breakoutRoomId: meta.roomId ? meta.roomId : null,
            parentStatsSessionId: meta.parentStatsSessionId ? meta.parentStatsSession : null
        };
