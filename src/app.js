...
const { firehose: { meetingStatsStream, pcStatsStream, trackStatsStream, e2ePingStream,
    region: firehoseAwsRegion } } = config;

if (meetingStatsStream && pcStatsStream && trackStatsStream && e2ePingStream && firehoseAwsRegion) {
