  ...
  switch (data[0]) {
    ...
    case 'onicecandidate':
      if (data[2] && data[2].candidate) {
        data[2].candidate = obfuscateCandidate(data[2].candidate); // eslint-disable-line no-param-reassign
      }
      break;
    ...
    case 'createAnswerOnSuccess':
      if (data[2] && data[2].sdp) {
        data[2].sdp = obfuscateSDP(data[2].sdp); // eslint-disable-line no-param-reassign
      }
      break;
    case 'getStats':
    case 'getstats':
